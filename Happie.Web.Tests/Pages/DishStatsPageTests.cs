...
public class DishStatsPageTests : BunitContext
{
    ...
    {
        // Act.
        var cut = Render<DishStatsPage>(parameters => parameters
    ...
    public void Render_ZeroCookingDaysInRange_DisplaysEmptyStateMessage()
    {
        ...
        cut.WaitForState(() => cut.FindAll(".dish-stats-page__empty-state").Count > 0, TimeSpan.FromSeconds(5));

        // Assert.
        var emptyState = cut.Find(".dish-stats-page__empty-message");
    ...
    public void Render_WithCookingData_DisplaysSummaryStatistics()
    {
        ...
        cut.WaitForState(() => cut.FindAll(".dish-stats-page__primary-count").Count > 0, TimeSpan.FromSeconds(5));

        // Assert.
        var primaryCount = cut.Find(".dish-stats-page__primary-count");
    ...
    public void Render_WithValidDish_DisplaysDishDescriptionAsHeading()
    {
        ...
        cut.WaitForState(() => cut.FindAll(".dish-stats-page__title").Count > 0, TimeSpan.FromSeconds(5));

        // Assert.
        var title = cut.Find(".dish-stats-page__title");
